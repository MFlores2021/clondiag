<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['w'] > 0) {
		...
		//if(substr($_POST['folder'],10)  ==  "thumbnail/" OR $_folder  ==  "thumbnail"){
							...
							?>
											<td width="33%">
												<form action="B1.php" method="post">
													...
													<br/>
													<p style="text-align: center;"><input type="submit" value="Rotate Image" class="btn btn-large btn-inverse" /></p>
												</form>
											</td>
											<td width="33%">
