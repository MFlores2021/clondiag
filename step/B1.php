<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if(isset($_POST['folder'])){
			...
			copy($src0,$src) or die("Unable to rename $src0. - $src");
			chmod($src, 0777);
			...
			header("location:B.php?photo=". $_POST['photo'] . "&screen=" . $_POST["screen"]."&return=rotate");
				...
				<div class="row">
					<div class="jc-demo-box">
						...
						<form action="B1.php" method="post">
							...
							<p style="text-align: center;"><input type="submit" name="run"  value="Save" class="btn btn-small btn-info"/></p>
						</form>
