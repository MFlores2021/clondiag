...
include_once "/var/www/clondiag/function/checkpermission.php";
	...
	$upload_path 		= $dir_c; //$upload_dir."/";				// The path to where the image will be saved
	$max_file 			= "8"; 							// Maximum file size in MB

	// Only one of these image types should be allowed for upload
	$image_location 	= $upload_path.$_FILES['image']['name'];	
	$allowed_image_typ 	= array('image/pjpeg'=>"jpg",'image/jpeg'=>"jpg",'image/jpg'=>"jpg",'image/png'=>"png",'image/x-png'=>"png",'image/gif'=>"gif");
...
<div class="content">
	...
	<div align="center"><span style="color: #23C6C1">Clondiag Page</span></div>
	<br/><br/>
