<?php
	...
	if(!isset($_SESSION)) {
		session_start();
		$currentProject	=	"sweetpotato3rditeration"; //$_SESSION["ClonDiagProject"];
		$currentTest	=	"18it3"; //$_SESSION["ClonDiagTest"];
		$currentBook	=	"datavirus.csv"; //$_SESSION["ClonDiagBook"];	
		$size_array		=	"15"; //$_SESSION["ClonDiagArray"];
		$currentUser	=	"mflores"; //$_SESSION["ClonDiagUser"];
		...
		<div class="wrap">
			...
			<div class="row">
				...
				<?php
					...
					$resulta 	= exec ("R --vanilla --slave '--args " . $_GET['photo'] . " " . implode("@",$tablavirus2).$nameslist . " " . $photo_dir . " " . implode("@",$names) . "' < /var/www/clondiag/R/code21.R");
					$fila4 = 0;
